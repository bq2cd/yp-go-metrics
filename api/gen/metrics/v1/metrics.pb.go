...
// UpdateMetricsResponse — ответ для подтверждения успешного обновления.
// Returns the list of updated metrics.
...
const file_metrics_v1_metrics_proto_rawDesc = "" +
	...
	"\ametrics\x18\x01 \x03(\v2\x12.metrics.v1.MetricR\ametrics2_\n" +
	"\aMetrics\x12T\n" +
	"\rUpdateMetrics\x12 .metrics.v1.UpdateMetricsRequest\x1a!.metrics.v1.UpdateMetricsResponseB=Z;github.com/bq2cd/yp-go-metrics/api/gen/metrics/v1;pbmetricsb\x06proto3"

var file_metrics_v1_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_metrics_v1_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
...
var file_metrics_v1_metrics_proto_depIdxs = []int32{
	...
	1, // 2: metrics.v1.UpdateMetricsResponse.metrics:type_name -> metrics.v1.Metric
	2, // 3: metrics.v1.Metrics.UpdateMetrics:input_type -> metrics.v1.UpdateMetricsRequest
	3, // 4: metrics.v1.Metrics.UpdateMetrics:output_type -> metrics.v1.UpdateMetricsResponse
