...
// Source: github.com/bq2cd/yp-go-metrics/internal/handler/router (interfaces: Handler)
//
// Generated by this command:
//
//	mockgen -destination=mock_handler_test.go -package=router github.com/bq2cd/yp-go-metrics/internal/handler/router Handler
//
